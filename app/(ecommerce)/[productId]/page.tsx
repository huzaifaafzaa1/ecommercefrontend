...
import { Product } from "@/type/type"; // Import types from type.ts
...
const ProductDescription = () => {
  ...
  const product = useSelector(
    (state: { productsStore: { products: Product[] } }) =>
  ...
  if (!product) {
    return (
      <p>
        Loading product details... If this takes too long, please go back and
  ...
  return (
    <div className="w-[65%] font-cabin ">
      <div>
        <Link href="/" className="flex gap-2 items-center my-5 py-2 px-3">
          <IoIosArrowBack />
          Back
        </Link>
      </div>
      ...
      <div className="">
        <div className="flex gap-3 ">
          <div className="flex gap-4 justify-center ml-3">
            <div className="flex flex-col items-center gap-2">
              <div className="h-14 w-14 bg-white flex justify-center items-center rounded-xl py-2 px-2">
                <img
                  src={product.image}
                  alt=""
                  className="max-h-14 max-w-14 py-2 px-2 "
                />
              </div>
            ...
            <div className="h-60 w-56 bg-white flex justify-center items-center rounded-xl">
              <img
                src={product.image}
                alt=""
                className="max-h-56 max-w-52 py-4 px-2 "
              />
            </div>
          </div>
          ...
          <div className="">
            ...
            <h2 className=" text-2xl px-4 py-1 text-darkgrey">
            ...
            <h2 className=" text-2xl px-4 py-2 font-semibold font-cabin">
              $ {product.price}
            </h2>
      ...
      <div className=" mb-4">
        <h2 className="text-2xl font-semibold px-4 py-2 font-cabin">
          Description
        </h2>
